// source: http://csbin.io/callbacks
...
console.log(map(["pizza", "banana", "element"], addS));
...
let forEachInput2 = "concatenatedStr:";
const forEachInput1 = [1, 2, 3, 4, 5]
forEach(forEachInput1, function(el) {
	forEachInput2 += el;
});
console.log(forEachInput1);
console.log(forEachInput2);
...
const mapWithInput = [1, 2, 3, 4, 5, 6];
console.log(`mapWith res: ${mapWith(mapWithInput, x => x * x)}`);
console.log(`mapWithInput after: ${mapWithInput}`);
